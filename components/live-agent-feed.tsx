...
const AGENT_NAMES = [
  "checkout.ts", "cart.ts", "pricing.ts", "discount.ts",
  "utils/tax.ts", "api/orders.ts", "hooks/useCart.ts", "lib/stripe.ts",
  "config/env.ts", "types/order.ts",
]

const TASKS = [
  "Scoring relevance for checkout bug fix",
  "Analyzing file dependencies",
  "Calculating token budget",
  "Blocking package-lock.json",
  "Summarizing large config file",
  "Routing to Nova context",
  "Extracting code snippets",
  "Filtering test files",
  "Compressing debug logs",
  "Building optimized prompt",
  "Comparing baseline tokens",
  "Generating context diff",
  "Validating token limits",
  "Preparing Nova request",
]

const REGIONS = ["allowed", "blocked", "summarized", "allowed", "blocked"]
const STATUSES = [
  { label: "allowed",    color: "#4ade80" },
  { label: "allowed",    color: "#4ade80" },
  { label: "allowed",    color: "#4ade80" },
  { label: "blocked",    color: "#f87171" },
  { label: "summarized", color: "#facc15" },
]
...
const SEED_ROWS: AgentRow[] = [
  { id: "A1B2C3", name: "checkout.ts",     task: "Scoring relevance for checkout bug",   region: "allowed",    status: STATUSES[0], progress: 42, elapsed: "1.2k", key: 0 },
  { id: "D4E5F6", name: "cart.ts",         task: "Analyzing file dependencies",          region: "allowed",    status: STATUSES[0], progress: 67, elapsed: "890", key: 1 },
  { id: "G7H8I9", name: "package-lock",    task: "Blocking lockfile — low relevance",    region: "blocked",    status: STATUSES[3], progress: 18, elapsed: "12k", key: 2 },
  { id: "J0K1L2", name: "pricing.ts",      task: "Calculating token budget",             region: "allowed",    status: STATUSES[0], progress: 55, elapsed: "650", key: 3 },
  { id: "M3N4O5", name: "debug.log",       task: "Summarizing large log file",           region: "summarized", status: STATUSES[4], progress: 80, elapsed: "8.4k", key: 4 },
  { id: "P6Q7R8", name: "auth/login.ts",   task: "Blocking unrelated module",            region: "blocked",    status: STATUSES[3], progress: 99, elapsed: "2.1k", key: 5 },
]
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {["FILE", "ACTION", "TOKENS", "STATUS"].map(h => (
